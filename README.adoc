...
|`::encode-value`
|`true`
|Encode EDN special value types with custom encoding, this is called for EDN keywords,
symbols, uuids, instant and any other thing that isn't a simple JSON atomic type.
|===
